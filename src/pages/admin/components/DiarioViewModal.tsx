              ...
              <TabsContent value="aulas" className="mt-6">
                <div className="bg-white border rounded-lg p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-lg font-bold text-gray-900">Registro de Aulas</h3>
                    <Button className="bg-blue-600 hover:bg-blue-700">+ Nova Aula</Button>
                  </div>
                  <div className="p-8 bg-gray-50 rounded-lg text-center text-gray-600">
                    <p className="text-sm">📝 Aulas registradas aparecerão aqui</p>
                  </div>

                  {/* EXEMPLO: Se tiver aulas, mostrar com botão de Presença */}
                  <div className="mt-6 border rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-semibold text-gray-900">Aula: 01/01/2025</p>
                        <p className="text-sm text-gray-600">Conteúdo: Introdução ao tema</p>
                      </div>
                      <Button 
                        variant="outline" 
                        size="sm"
